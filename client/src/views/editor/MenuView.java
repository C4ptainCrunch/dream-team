...
public class MenuView extends JMenuBar {
    ...
    private void addShortcutItem(final JMenu menu, final Action action, final String label, final String key, final int shortcut_key,
            final int key_mask) {
    ...
    /**
     * Calls the saveAndQuit function of the controller of this view. This will
     * saveAndQuit the tikz text into a file in the current diagram's file
     */
