...
public class RectangleDrawer extends NodeDrawer {
    ...
    /**
     * Creates a swing drawable rectangle object by adding a Rectangle shape to
     * the list of shapes of the drawable and correctly setting its position.
     *
     * @param component
     *            tikz rectangle to draw
     * @param panel
     *            panel to draw onto
    ...
    /**
     * Creates an awt rectangle from the width and height of the given
     * TikzRectangle
     *
     * @param rectangle
     *            the TikzRectangle to create an awt rectangle from
     * @return the awt rectangle
     */
    public Rectangle getAwtRectangle(TikzRectangle rectangle) {
        return new Rectangle((int) Converter.centimetersToPixels(rectangle.getWidth()),
                (int) Converter.centimetersToPixels(rectangle.getLength()));
    }

    /**
     * Determines the anchors of the given rectangle. Uses the shape bounds.
     *
     * @param node
     *            rectangle to get the anchors from.
     * @param panel
     *            panel on which the rectangle is drawn
