...
public class TransferableTikz implements Transferable {
    ...
    private TikzComponent component; // The "real" object that will be passed through d&d.

    public TransferableTikz(TikzComponent comp) {
        String mimeType = DataFlavor.javaJVMLocalObjectMimeType + ";class=" + TikzComponent.class.getName();  // Identifier for the data passed.
        try {
    ...
    public Object getTransferData(DataFlavor df) throws UnsupportedFlavorException, IOException {
        ...
        if (df.equals(data)) {  // this checked if the identifier of the source is an particular object (cf. mimeType above).
            return component;
        }
