...
/**
 * Implementation of the Undirected Edge Model (from the MVC architectural pattern)
 * This class represents an undirected edge that links two
 * tikz node.
 */
public class TikzUndirectedEdge extends TikzEdge {
     ...
     * @param o_edge The undirected edge to be copied from
     */
     ...
     * @return A new undirected edge that is the copy of the current undirected edge
     */
    @Override
